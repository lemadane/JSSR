...
public class JssrBytecodeCompilerTest {
    ...
    void testSimpleComponentBytecodeCompilation() {
        ...
        assertEquals(CompilationStatus.COMPILED, JssrPrecompiler.status(SimpleUser.class));
    ...
    void testSecurityEnforcementInPrecompiledBytecode() {
        ...
        assertEquals(CompilationStatus.COMPILED, JssrPrecompiler.status(SecurityTestCard.class));
    ...
    void testUnsafeUrlInPrecompiledExecution() {
        ...
        // Dynamic interpolation inside URL attribute requires SafeUrl typed field, raw String throws IllegalArgumentException in precompiled bytecode
        ...
        assertEquals(CompilationStatus.COMPILED, JssrPrecompiler.status(UnsafeStringUrlCard.class),
                "UnsafeStringUrlCard must achieve COMPILED status without unreachable statement compilation errors");
    }
    ...
    @Test
    @DisplayName("Verify generated Java code emits direct AST statements without calling string runtime interpreters")
    void testGeneratedSourceDoesNotContainRuntimeInterpreter() {
        com.jssr.core.compiler.JavaCodeGenerator generator = new com.jssr.core.compiler.JavaCodeGenerator();
        String generated = generator.generateClassSource(SimpleUser.class, "GeneratedSimpleUser");

        assertNotNull(generated);
        assertFalse(generated.contains("processControlFlow"), "Generated bytecode class source must not call processControlFlow");
        assertFalse(generated.contains("interpolateVariables"), "Generated bytecode class source must not call interpolateVariables");
        assertFalse(generated.contains("processCustomTags"), "Generated bytecode class source must not call processCustomTags");
        assertTrue(generated.contains("sb.append"), "Generated bytecode class source must emit direct sb.append statements");
    }
}
